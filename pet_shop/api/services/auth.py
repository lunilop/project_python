...
class AuthService:
    ...
    def login_and_set_access_token(
        ...
        print("Datos del usuario para el token:", userdata)
...
class SecurityService:
    ...
    def is_employee(self):
        ...
        return role == "admin" or role == "employee"
    ...
    @property
    def is_employee_or_raise(self):
        role = self.auth_user_role
        assert role == "admin" or role == "employee", "User does not have employee role"
