...
#             )
#     @classmethod
#     def get_user_orders(cls, user_id: PydanticObjectId):
#         orders = db["orders"].find({"customer_id": user_id})
#         return [StoredOrder.model_validate(order).model_dump() for order in orders]
